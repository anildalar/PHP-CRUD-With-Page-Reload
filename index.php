<?php 
    ...
    if( (isset($_GET['action']) && ( $_GET['action'] == 'delete') ) ){
       ...
       echo  $id = (int)mysqli_real_escape_string($conn,$_GET['delid']);
        ...
        //2. Build the query
        $sql = "DELETE FROM `students_tbl` WHERE id='$id'"; //Where clause
    ...
    if( isset($_GET['student_edit_btn']) ){
        ...
        WHERE condition;
         */
        $sql = "UPDATE students_tbl SET name='$name',surname='$surname',address='$address',mobno='$mobileno' WHERE id='$editid'";
    ...
    <body>
        ...
        <div class="row">
            <div class="col-6 offset-3">
                <h1 class="text-center mt-5">Student <?php echo ( isset($_GET['action']) && ($_GET['action']=='edit') ) ? 'Update' :'Registration' ?> </h1>
                <?php 
                    echo $msg;
                ?>
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="GET">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="address" value="<?php echo is_array($row)? $row[3]:'' ?>" class="form-control" id="address" aria-describedby="emailHelp" required>
                        <div id="emailHelp" class="form-text"></div>
                    </div>
                    <div class="mb-3">
                       ...
                       // echo '</pre>';
                         $row .= '<tr>
                                            ...
                                            <td>
                                                ...
                                                <a onClick="return confirm(\'Are you sure\') " href="?action=delete&delid='.$row2['id'].'" class="btn btn-danger btn-sm">DELETE</a>    
                                            </td>
                                        </tr>'; 
                                        //
        ...
        <script>
            ...
            (function(){
                ...
                $(document).on('click', 'a.viewstudent',function(){
                    ...
                    var address = this.closest('tr').querySelector('td:nth-child(4)').innerHTML ;
                   ...
                   /*  $('table.mytable tbody > tr > td:nth-child(2)').innerHTML = name;
                    ...
                    $('table.mytable tbody > tr > td:nth-child(4)').innerHTML = address;
